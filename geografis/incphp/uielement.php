...
class UiElement
{
    ...
    */
    public static function pmHeader()
    {
		...
		$pmHeading = array_key_exists('pmHeading', $_SESSION) ? $_SESSION['pmHeading'] : "Sistem Informasi Geografis Pencarian Ruang Kuliah IPB Darmaga";
		
        /*$html = "<div class=\"pm-header\">
					<div><a href=\"$pmLogoUrl\" 
    ...
    */
    public static function pmFooter()
    {
        $html = "<div class=\"pm-footer\">
                ...
                <div style=\"float:right;\"><a href=\"../\"><img src=\"images/back.png\" /></a>
                </div>
                </div>
        ";
        return $html;
